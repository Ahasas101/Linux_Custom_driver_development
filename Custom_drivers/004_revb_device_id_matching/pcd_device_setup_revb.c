...
/* Creating 2 platform data*/
struct pcdev_platform_data pcdev_pdata[4] = {
	[0] = {.size = 512, .perm = RDWR, .serial_number = "PCDEVXYZ111"},
	[1] = {.size = 1024, .perm = RDWR, .serial_number = "PCDEVXYZ222"},
	[2] = {.size = 128, .perm = RDONLY, .serial_number = "PCDEVXYZ333"},
	[3] = {.size = 32, .perm = WRONLY, .serial_number = "PCDEVXYZ444"}
};

/*Creating 2 platform devices*/
